...
class Aplicacao(Enum):
    ...
    E_HEALTH_3 = (3, 'Navegação Web', 2.0, 1.0, 5.0, 0.55, 0.5)

    E_LEARNING_4 = (4, 'EaD', 13.9, 1.0, 5.0, 0.55, 0.16)
    E_LEARNING_5 = (5, 'Navegação Web', 2.0, 1.0, 5.0, 0.55, 0.16)

    E_GOV_6 = (6, 'Monitoramento de Vias', 8.0, 1.0, 10.0, 0.55, 1.0)
    E_GOV_7 = (7, 'Navegação Web', 2.0, 1.0, 5.0, 0.55, 0.16)
