...
class CAPEX(Enum):
    ...
    # Tempo de Instalação de HW por tipo de BS
    TEMPO_INSTALACAO_MW_SMALL = ('Tempo de Instalacao de Link MW SMALL', 'horas', 3.0)
    TEMPO_INSTALACAO_MW_LARGE = ('Tempo de Instalacao de Link MW SMALL', 'horas', 6.0)
    TEMPO_INSTALACAO_SW = ('Tempo de Instalacao de SW', 'horas', 1.0)

    ANTENA_MW_SMALL = ('Antena MW', '$/unidade', 0.005191)
    ANTENA_MW_LARGE = ('Antena MW', '$/unidade', 0.020764)
    SW_CARRIER = ('Switch Carrier', '$/unidade', 0.018687)

    HASTE_MW = ('Haste Antena MW', '$/unidade', 0.003789)
