...
class Equipamento(Enum):
    ...
    MBS = ('Macro Base Station e Cell Site', 1000.0, '$/unidade')
    MiBS = ('Micro Base Station e Cell Site', 1000.0, '$/unidade')
    ...
    def __str__(self):
        return 'Equipamento nome={}, preco_unitario={}, unidade_precificacao={}, desconto={}'.format(self.nome,
                                                                                                     self.preco_unitario,
                                                                                                     self.unidade_precificacao,
                                                                                                     self.desconto)
