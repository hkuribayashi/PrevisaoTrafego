...
class TipoBS(Enum):
    ...
    PICO_4G = ('Pico', '4G', 'indoor', 1.0, 132.0, 0.03, 1.0, 1.0, True)
    ...
    PICO_45G = ('Pico', '4.5G', 'indoor', 1.0, 291.78, 0.03, 1.0, 1.0, False)
    ...
    PICO_5G = ('Pico', '5G', 'indoor', 1.0, 1132.0, 0.013, 1.0, 1.0, False)
